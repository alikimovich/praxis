...
export const chatIslandDescription = 'Generate an interactive native island INSIDE this chat. Call catalog first, inspect/instrument project values, then define literal bindings and meaningful groups. Jev selects/ orders blocks. Supports numbers, toggles, text, color, select, Bezier and 2D points (light position). Read current values before revising an island. Source becomes editable after successful landing. No model calls on control gestures.'
