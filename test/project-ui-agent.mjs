...
try {
  ...
  if (/not logged in|please.*login|unauthorized|invalid api key|credentials.*missing|hit your .*limit|usage limit|rate limit/i.test(transcript)) {
    ...
    writeFileSync('test/artifacts/project-ui-preview.png', Buffer.from(png, 'base64'))
